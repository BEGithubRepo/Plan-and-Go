"""
Django settings for plan_go project.
...
ALLOWED_HOSTS = ['localhost:8000','http://127.0.0.1:8000', '*']
...
SIMPLE_JWT = {
    'USER_ID_FIELD': 'id',  # Custom User UUID kullanımı
...
WSGI_APPLICATION = 'plan_go.wsgi.application'
